...
SRC_URI="https://github.com/SoftFever/OrcaSlicer/releases/download/v${PV}/OrcaSlicer_Linux_AppImage_Ubuntu2404_V${PV}.AppImage"
...
src_unpack() {
	cp ${DISTDIR}/OrcaSlicer_Linux_AppImage_Ubuntu2404_V${PV}.AppImage orcaslicer.appimage || die "Can't copy source file"
