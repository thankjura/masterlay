...
PATCHES=(
	...
	"${FILESDIR}/orcaslicer-2.3.0-fix1.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix2.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix3.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix4.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix5.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix6.patch"
	"${FILESDIR}/orcaslicer-2.3.0-fix-libnoise.patch"
)
...
src_configure() {
	...
	local mycmakeargs=(
		...
		-DLIBNOISE_LIBRARY="/usr/$(get_libdir)/libnoise.so.1.0.0"
