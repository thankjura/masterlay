...
if [[ "${PV}" == *9999* ]] ; then
	...
	SRC_URI="
		...
		https://github.com/cpm-cmake/CPM.cmake/releases/download/v0.40.2/CPM.cmake -> ${P}-CPM.cmake
	"
...
PATCHES=(
	...
	"${FILESDIR}/add_cccl.patch"
	"${FILESDIR}/fix_cmake.patch"
)
...
src_prepare() {
	cp ${DISTDIR}/${P}-CPM.cmake ${WORKDIR}/CPM.cmake
